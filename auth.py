...
def start_spotify_session(config):
    """
    Start a Spotify session using the credentials in the config file.
    """
...
def start_tidal_session(config=None):
    """
    Start a Tidal session using the credentials in the config file.
    """
    try:
